 ...
 * @author gabor
 */
public class PassStoreApplet extends javax.swing.JApplet {

    /**
     * Initializes the applet PassStoreApplet
     */
    @Override
    public void init() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PassStoreApplet.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        try {
            ...
            Logger.getLogger(PassStoreApplet.class.getName()).log(Level.SEVERE, null, ex);
        }
        try {
            while(res.next())
            {
